  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div className="bg-card rounded-lg shadow-lg p-6 border-l-4 border-red-600">
      ...
      <div className="bg-card rounded-lg shadow-lg p-6">
        <h3 className="text-xl font-bold text-secondary mb-4">Performance Statistics</h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-primary/5 rounded-lg p-4">
            <div className="text-sm font-medium text-primary mb-1">Pass Rate</div>
            <div className="text-2xl font-bold text-secondary">{Math.round(analytics.attempts?.passRate || 0)}%</div>
          ...
          <div className="bg-green-50 rounded-lg p-4">
            ...
            <div className="text-2xl font-bold text-secondary">{Math.round(analytics.scores?.highest || 0)}%</div>
          </div>
          <div className="bg-yellow-50 rounded-lg p-4">
            <div className="text-sm font-medium text-yellow-600 mb-1">Lowest Score</div>
            <div className="text-2xl font-bold text-secondary">{Math.round(analytics.scores?.lowest || 0)}%</div>
          </div>
        </div>
      </div>
      ...
      {performanceTrend.length > 0 && (
        <div className="bg-card rounded-lg shadow-lg p-6">
          <h3 className="text-xl font-bold text-secondary mb-4">Recent Performance Trend</h3>
      ...
      {performanceTrend.length > 0 && (
        <div className="bg-card rounded-lg shadow-lg p-6">
          <h3 className="text-xl font-bold text-secondary mb-4">Score Distribution</h3>
          <ResponsiveContainer width="100%" height={300}>
