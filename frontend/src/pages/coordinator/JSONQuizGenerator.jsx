...
const JSONQuizGenerator = () => {
  ...
  const getTypeColor = (type) => {
    switch (type) {
      case 'mcq': return 'bg-primary/10 text-[#1d4ed8]';
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-primary/5 border border-blue-200 rounded-lg p-4 mb-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-[#1d4ed8] mt-1">Follow our step-by-step guide to use ChatGPT</p>
            </div>
            <a
        ...
        <div className="bg-card border border-border rounded-lg shadow-md p-6 mb-6">
          <h3 className="text-lg font-bold text-secondary mb-3">📝 Step 1: Paste JSON from ChatGPT</h3>
          <textarea
            value={jsonInput}
          ...
          <div className="bg-card border border-border rounded-lg shadow-md p-6 mb-6">
            ...
            <div className="bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg p-4 mb-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <div className="font-medium text-secondary mt-1">{parsedData.questions.length}</div>
                </div>
                <div>
            ...
            <div className="max-h-96 overflow-y-auto space-y-4 mb-6">
              {parsedData.questions.map((q, idx) => (
                <div key={idx} className="border border-border rounded-lg p-4 hover:bg-gray-50 transition-colors">
                  <div className="flex justify-between items-start mb-2">
                    <div className="font-medium text-secondary flex-1">
            ...
            <div className="flex gap-3">
              <button
                ...
                disabled={loading}
                className="flex-1 flex items-center justify-center gap-2 bg-primary text-white py-3 rounded-lg hover:bg-[#1d4ed8] disabled:bg-gray-400 disabled:cursor-not-allowed font-medium text-lg transition-colors"
              >
                {loading ? (
                  <>
        ...
        <div className="bg-card border border-border rounded-lg shadow-md p-6">
          <h3 className="font-bold text-secondary mb-3">💡 Tips:</h3>
