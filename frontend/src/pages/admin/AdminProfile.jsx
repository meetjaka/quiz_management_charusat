  ...
  return (
    <div className="min-h-screen bg-secondary-50 py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-secondary-900">Admin Profile</h1>
          <p className="text-secondary-600">Manage your administrative profile and view system overview</p>
        </div>
            ...
            >
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-semibold text-secondary-900">{stats.totalUsers}</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-secondary-600">Total Groups</span>
                  <span className="font-semibold text-secondary-900">{stats.totalGroups}</span>
                </div>
                <div className="flex items-center justify-between">
            ...
            >
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-secondary-600">Administrator Access</span>
                </div>
              </div>
            </motion.div>
          </div>
