      ...
      <div className="space-y-8">
        ...
        >
          {analytics ? (
            ...
            <div className="rounded-md border border-red-100 bg-card p-12 text-center subtle-shadow">
              ...
              <button
                onClick={fetchAnalytics}
                className="mt-6 px-4 py-2 bg-card border border-gray-300 text-gray-700 font-medium rounded-lg hover:bg-gray-50 transition-colors subtle-shadow"
              >
                Try Again
              </button>
            </div>
