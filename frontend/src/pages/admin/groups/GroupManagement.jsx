        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="inline-flex items-center px-4 py-2 bg-primary text-white rounded-lg hover:bg-[#1d4ed8] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors"
            >
        ...
        {filteredGroups.length === 0 && (
          <div className="text-center py-12">
            ...
            {!searchTerm && (
              <button
                onClick={handleCreateGroup}
                className="inline-flex items-center px-4 py-2 bg-primary text-white rounded-lg hover:bg-[#1d4ed8]"
              >
                <FiPlus className="mr-2 h-4 w-4" />
                Create Group
              </button>
